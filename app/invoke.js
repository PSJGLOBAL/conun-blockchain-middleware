...
const invokeTransaction = async (channelName, chaincodeName, fcn, args, wallet_address, org_name) => {
    try {
        ...
        //-=-=-=-
            ...
            result = await contract.submitTransaction(fcn, wallet_address, args[1])
            console.log(result.toString())
        } else if (fcn === "BalanceOf") {
            result = await contract.submitTransaction(fcn, wallet_address)
        } else {
